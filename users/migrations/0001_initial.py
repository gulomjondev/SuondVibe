    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth_status', models.CharField(choices=[('new', 'new'), ('code', 'code'), ('done', 'done'), ('photo_step', 'photo_step')], max_length=31)),
                ('auth_type_choices', models.CharField(choices=[('via_phone', 'via_phone'), ('via_email', 'via_email')], max_length=31)),
